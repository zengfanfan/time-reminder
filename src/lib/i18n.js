...
const translations = {
    zh: {
        ...
        playSound: "提醒时播放提示音",
        fullscreenLabel: "全屏提醒",
        fullscreenDesc: "开启后遮盖整个屏幕；关闭则在右下角显示小窗口",
        listenBtn: "🔊 试听",
        preview: "预览",
        createBtn: "创建提醒",
        saveBtn: "保存修改",
        ...
        settingsSoundVolumeDesc: "调整提醒时播放的提示音音量",
        unitSeconds: "秒",
        unitMinutes: "分钟",
        unitHours: "小时",
    ...
    en: {
        ...
        textPlaceholder: "Text shown on the overlay…",
        playSound: "Play sound on reminder",
        fullscreenLabel: "Fullscreen overlay",
        fullscreenDesc: "Cover the whole screen; off shows a small corner notification",
        listenBtn: "🔊 Preview",
        preview: "Preview",
        ...
        settingsSoundVolumeDesc: "Adjust the volume of the reminder chime",
        unitSeconds: "sec",
        unitMinutes: "min",
        unitHours: "hr",
